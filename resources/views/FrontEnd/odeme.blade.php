                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Seher <span class="required"></span></label>
                            ...
                            <div class="payment-method-form show" id="credit-card">
                                ...
                                <div class="payment-method-form-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <div class="form-group">
                                                <label for="kartin_adi">Name on Card</label>
                                                <input type="text" name="kartin_adi" id="kartin_adi" class="form-control">
                                            </div> <!-- /.form-group -->
                                        </div> <!-- /.col-md-8 -->
                                        <div class="col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label for="kartin_3reqemli_kodu">Code</label>
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" >Odeme Et</input>
